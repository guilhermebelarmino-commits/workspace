...
create or replace table `meli-bi-data.SBOX_CREDITS_SB.RBA_TC_MLB_DOWNSELL_BACKTEST_BAU_1_PECASTANHO_TMP`
options (
...
drop table if exists `meli-bi-data.SBOX_CREDITS_SB.RBA_TC_MLB_DOWNSELL_BACKTEST_BAU_1_PECASTANHO`;

create or replace table `meli-bi-data.SBOX_CREDITS_SB.RBA_TC_MLB_DOWNSELL_BACKTEST_BAU_1_PECASTANHO`
(
   campaign_id STRING
  ,f_acc_carga DATE
...
insert into `meli-bi-data.SBOX_CREDITS_SB.RBA_TC_MLB_DOWNSELL_BACKTEST_BAU_1_PECASTANHO` (
   campaign_id
  ,f_acc_carga
  ,f_mes_acc_carga
  ,f_acc_impacto
...
select
  *
from `meli-bi-data.SBOX_CREDITS_SB.RBA_TC_MLB_DOWNSELL_BACKTEST_BAU_1_PECASTANHO_TMP`
;